## Jupyter/MiniConda Docker Image

### Summary

The containers allows the user to run Jupyter-Notebooks (Python 3.6.1), installed using Miniconda3, running in a ubuntu 16.04 environment.
